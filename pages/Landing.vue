...
export default {
  ...
  data() {
    return {
      ...
      { id: 1, jumboTagline: "All local playground info in one place.", jumboSubTag: "You're too busy for multi-tabbing.", jumboCopy: "They're your playgrounds afterall— let's make it easy to get there!", jumboButton: "Let's Go!" },
